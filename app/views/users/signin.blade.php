					...
					<div class="sign__content">
						...
						<form action="" class="sign__form" method="post">
							...
							<div class="sign__group">
								<input type="text" class="sign__input" placeholder="Email" name="email" value="{{isset($_COOKIE['email'])?$_COOKIE['email']:''}}">
							</div>
							<h3 style="color: #fff;">{{isset($err["email"])?$err["email"]:""}}</h3>
              <div class="sign__group">
                <input type="password" class="sign__input" placeholder="Password" name="password" value="{{isset($_COOKIE['pass'])?$_COOKIE['pass']:''}}">
              </div>
...
<span class="sign__text">Don't have an account? <a href="sign-up">Sign up!</a></span>
