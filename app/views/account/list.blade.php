        ...
        <div class="content"><!-- For Components documentaion -->
          ...
          <div class="card card-default">
            <div class="card-header">
              <h2>Accounts Inventory</h2>
              <a href="{{route('add-account')}}"><button type="button" class="btn btn-sm btn-outline-primary">ADD NEW</button></a>
            </div>
            <div class="card-body">
              ...
              <table id="productsTable" class="table table-hover table-product" style="width:100%">
                ...
                @foreach($account as $ac)
                  <tr>
                    ...
                    <td>{{$ac->role}}</td>
                    <td>
                      <a href="{{route('edit-account/'.$ac->id)}}"> <button type="button" class="btn btn-sm btn-outline-success">EDIT</button></a>
                      <a href="{{route('delete-account/'.$ac->id)}}"><button type="button" class="btn btn-sm btn-outline-warning">DELETE</button></a>
                    </td>
                  </tr>
                @endforeach
                </tbody>
