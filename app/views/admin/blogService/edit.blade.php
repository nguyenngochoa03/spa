      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="breadcrumb-main">
            <h4 class="text-capitalize breadcrumb-title">Edit Document</h4>
          ...
          <div class="col-lg-12">
            <div class="card card-default card-md mb-4">
              ...
              <div class="card-body py-md-25">
                <form action="{{route('update-blog-service/'.$blog->id)}}" method="post" enctype="multipart/form-data">
                  <div class="row">
                      ...
                      <div class="dm-select ">
                        <select name="serbl" class="select-search form-control ">
                          ...
                          @foreach($service as $sv)
                            <option value="{{$sv->id}}" <?php echo $sv->id == $blog->id_service ? 'selected' : '' ?>>{{$sv->name}}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
                    <div class="col-md-12">
                      ...
                      <div class="col-lg-6">
                        <div class="card card-default card-md mb-4">
                          ...
                          <div class="card-body">
                            <img src="{{route('public/upload/blogSv/'.$blog->image)}}" style="width: 300px">
                          </div>
                        </div>
                        <div class="card card-default card-md mb-4">
                          <div class="card-header  py-20">
                      ...
                      <div class="form-group">
                        ...
                        >
                        <textarea name="contentbl"  id="content-blog" cols="20" rows="20">{{$blog->content}}</textarea>
                      </div>
                      <div
